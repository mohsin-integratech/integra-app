...
function useRangeSlider(props) {
  ...
  var valueBounds = getValueBounds(value, min, max);
...
var getValueBounds = function getValueBounds(arr, min, max) {
  return arr.map(function (v, i) {
    var _arr, _arr2;

    return {
      min: (_arr = arr[i - 1]) != null ? _arr : min,
      max: (_arr2 = arr[i + 1]) != null ? _arr2 : max
    };
  });
};
